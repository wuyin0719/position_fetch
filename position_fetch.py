...
class PositionGetter:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PositionGetter_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&SUTPC Plugins')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'PositionGetter')
        self.toolbar.setObjectName(u'PositionGetter')

        #print "** INITIALIZING PositionGetter"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PositionGetter', message)
    ...
    def unload(self):
        ...
        #print "** UNLOAD PositionGetter"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&SUTPC Plugins'),
                action)
